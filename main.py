...
def main():
    ...
    Dport =  arg_results.Dport
    remote = arg_results.remote

    dht.setup(Dport, remote)
...
def get_arg():
    ...
    arg_parser.add_argument('-D', '--Dport', dest='Dport', default=8000, type=int,
                            help='Listen on a different DHT port')
    arg_parser.add_argument('-remote', dest='remote', default='127.0.0.1:8000',
